...
function make_slides(f) {
  ...
  if (exp.condition == "control") {
    present_list = _.shuffle(control);
  } else if (exp.condition == "target") {
    present_list = _.shuffle(target);
  } else if (exp.condition == "nottarget") {
    present_list = _.shuffle(nottarget);
  } else if (exp.condition == "symmetric") {
    present_list = _.shuffle(symmetric);
  }
...
slides.critical = slide({
    ...
    present_handle : function(stim) {
      ...
      $(".prompt").html('Mr. Davis: <b>"' + stim.ref_pretty + " " + stim.noun_pretty + '."</b>');
